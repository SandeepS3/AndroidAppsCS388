...
class MainActivity : AppCompatActivity() {
    private val articles = mutableListOf<DisplayArticle>() // Change to DisplayArticle
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val articleAdapter = ArticleAdapter(this, articles) // Change to use DisplayArticle
